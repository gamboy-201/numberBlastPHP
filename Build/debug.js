    ...
    var Main = /** @class */ (function () {
        ...
        Main.prototype.DrawEnvironmentAndPlayer = function (loader, resources) {
            ...
            for (var _a = 0, playerList_1 = surya_1.playerList; _a < playerList_1.length; _a++) {
                ...
                var resource = resources[imageid[0]];
                var newSprite = new surya_1.CollisionShape(true, "circle", 200, 485, 10, 10, { isStatic: false, friction: 0, restitution: 1, inertia: Infinity, frictionAir: 0, frictionStatic: 0, collisionFilter: { category: 0x0002, mask: 0x0001 } });
        ...
        Main.prototype.CreateNewPlayer = function (x, y, index, fakePlayer) {
            ...
            toDestroy.destroy();
            this.playerNum++;
            var newSprite = new surya_1.CollisionShape(true, "circle", x, y, 10, 10, { isStatic: false, friction: 0, restitution: 1, inertia: Infinity, frictionAir: 0, frictionStatic: 0, collisionFilter: { category: 0x0002, mask: 0x0001 } });
            newSprite.justRemoveBody();
            newSprite.beginFill(0xffff00, 1).drawCircle(0, 0, 10).endFill();
