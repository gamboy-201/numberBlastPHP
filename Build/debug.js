                ...
                var _loop_2 = function (player) {
                    if (this_1.playerArray.hasOwnProperty(player)) {
                        ...
                        if (this_1.playerArray[player].y > 500 && !this_1.playerArray[player].bodyRemoved) {
                            ...
                            _this_3.playerArray[player].justRemoveBody();
                            _this_3.playerArray[player].y = 485;
                            if (this_1.playersDroppedDown == this_1.currentlyPlayingPlayers) {
                                this_1.currentlyPlayingPlayers = 0;
                                _this_3.ballMoving = false;
                                this_1.playersDroppedDown = 0;
                                if (this_1.blockCouter * 50 > 350 && Object.keys(this_1.destructibleCubeArray[this_1.blockCouter]).length > 0) {
                                    _this_3.MoveDownAndDestroyAll();
                                }
                                else {
                                    setTimeout(function () {
                                        _this_3.drawBlockShapes(++_this_3.blockCouter);
                                        _this_3.MoveAllPlayersToOriginalPos();
                                    }, 500);
                                }
                            }
                        }
