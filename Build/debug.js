...
(function (surya_1) {
    surya_1.style = {
        ...
        wordWrap: true,
        wordWrapWidth: 400,
    }, surya_1.styleValueNumberOfBalls = {
        fontFamily: 'Arial',
        fontSize: 15,
        fontStyle: '',
        fontWeight: 'bold',
...
(function (surya_1) {
    var Main = /** @class */ (function () {
        function Main() {
            ...
            this.tweenedDownPlayer = [];
            this.pathArrCircle = [{ x: -12, y: 0 }, { x: 0, y: -12 }, { x: 12, y: 0 }, { x: 0, y: 12 }];
        ...
        Main.prototype.drawBaseLineAndScoreText = function () {
            ...
            this.scoreValue.resolution = 3;
            this.numberOfBallsText = new PIXI.Text("", surya_1.styleValueNumberOfBalls);
            this.middleContainer.addChild(this.numberOfBallsText);
            this.numberOfBallsText.x = 200;
            this.numberOfBallsText.y = 460;
            this.numberOfBallsText.visible = false;
            this.numberOfBallsText.text = "0";
            this.numberOfBallsText.resolution = 3;
        };
        Main.prototype.drawBlockShapes = function (i) {
            ...
            for (var j = 0; j < 8; j++) {
                ...
                if (randomValue == 0) {
                    ...
                    this.destructibleCubeArray[i][this.blockCount] = new surya_1.CollisionShape(true, "rect", j * 50, i * 50, 50, 50, { isStatic: true, friction: 0, restitution: 1, collisionFilter: { category: 0x0001 } });
                    ...
                    this.destructibleCubeArrayText[i][this.blockCount].resolution = 3;
                    ...
                    if (randomValue === 1) {
                        ...
                        newSprite.beginFill(0xffffff, 1).drawCircle(0, 0, surya_1.circleRad).endFill();
                        this.fakePlayerArray[i][fakeplayerNum] = this.innerContainer.addChild(newSprite);
                        this.fakePlayerArray[i][fakeplayerNum].x = j * 50 + 22;
                        this.fakePlayerArray[i][fakeplayerNum].y = 27;
                        var outerCircle = new PIXI.Graphics();
                        outerCircle.lineStyle(2, 0xFFFFFF); //(thickness, color)
                        outerCircle.drawCircle(0, 0, 12); //(x,y,radius)
                        outerCircle.endFill();
                        this.fakePlayerArray[i][fakeplayerNum].addChild(outerCircle);
                        var atomCircle = new PIXI.Graphics();
                        atomCircle.beginFill(0xffffff, 1).drawCircle(0, 0, 4).endFill();
                        atomCircle.position.set(-12, 0);
                        this.fakePlayerArray[i][fakeplayerNum].addChild(atomCircle);
                        this.PlayCircleAnimation(atomCircle);
                        fakeplayerNum++;
                    }
                }
            }
        ...
        Main.prototype.PlayCircleAnimation = function (objForAnim) {
            if (objForAnim && objForAnim.parent) {
                var timeLineTween = new TimelineMax({
                    onComplete: this.PlayCircleAnimation.bind(this, objForAnim),
                });
                timeLineTween.to(objForAnim, {
                    duration: 1,
                    ease: "linear",
                    motionPath: {
                        path: this.pathArrCircle
                    }
                });
            }
            if (!objForAnim.parent) {
                objForAnim.destroy();
            }
        };
        ...
        Main.prototype.ShowBlinkingText = function () {
            ...
            this.circleFade.beginFill(0xffffff, 1).drawCircle(0, 0, 10).endFill();
        ...
        Main.prototype.DrawEnvironmentAndPlayer = function (loader, resources) {
            ...
            for (var _i = 0, borderList_1 = surya_1.borderList; _i < borderList_1.length; _i++) {
                ...
                var newSprite = new surya_1.CollisionShape(true, "rect", imageid[1], imageid[2], imageid[3], imageid[4], { isStatic: true, friction: 0, restitution: 1, collisionFilter: { category: 0x0001 } });
            ...
            for (var _a = 0, playerList_1 = surya_1.playerList; _a < playerList_1.length; _a++) {
                ...
                var resource = resources[imageid[0]];
                var newSprite = new surya_1.CollisionShape(true, "circle", 200, 485, surya_1.circleRad, surya_1.circleRad, { isStatic: false, friction: 0, restitution: 1, inertia: Infinity, frictionAir: 0, frictionStatic: 0, collisionFilter: { category: 0x0002, mask: 0x0001 } });
            ...
            var rectColliderRight = new surya_1.CollisionShape(true, "rect", 375, 5, 50, 50, { isStatic: true, friction: 0, restitution: 1, collisionFilter: { category: 0x0001 }, angle: 45 });
            // rectColliderRight.beginFill(0x800080, 1).drawRect(0, 0, 50, 50).endFill();
            rectColliderRight.x = 400;
            rectColliderRight.y = 30;
            rectColliderRight.angle = 45;
            rectColliderRight.pivot.set(25, 25);
            rectColliderRight.name = "rightTop";
            this.innerContainer.addChild(rectColliderRight);
            // this.StartGame();
            var rectColliderLeft = new surya_1.CollisionShape(true, "rect", -25, 5, 50, 50, { isStatic: true, friction: 0, restitution: 1, collisionFilter: { category: 0x0001 }, angle: 45 });
            // rectColliderLeft.rotation=0.78;
            // rectColliderLeft.body.angle=0.78;
            // rectColliderLeft.beginFill(0x800080, 1).drawRect(0, 0, 50, 50).endFill();
            rectColliderLeft.x = 0;
            rectColliderLeft.y = 30;
            rectColliderLeft.angle = 45;
            rectColliderLeft.pivot.set(25, 25);
            rectColliderLeft.name = "leftTop";
            this.innerContainer.addChild(rectColliderLeft);
            this.StartGame();
        };
            ...
            if (this.pointerDown && !this.playingInitialAnim) {
                if (e.data) {
                    ...
                    if (angleInBetween >= 0 && angleInBetween <= 180) {
                        alpha = this.CalculateInOtherDirection(e);
                    }
            ...
            if (this.playingInitialAnim) {
                if (this.containerArray["EmitterContainer"]) {
                    if (this.containerArray["EmitterContainer"].parent) {
                        ...
                        angleInBetween = (alpha * 180) / 3.14;
                        if (angleInBetween >= 0 && angleInBetween <= 180) {
                            alpha = this.CalculateInOtherDirectionInitial();
                        }
                        this.containerArray["EmitterContainer"].rotation = alpha;
                    }
                }
        ...
        Main.prototype.CalculateInOtherDirectionInitial = function () {
            var pos = { x: this.spriteArray["hand"].worldTransform.tx, y: this.spriteArray["hand"].worldTransform.ty };
            var firstDirection = { x: 1, y: 0 };
            var secondDirection = { x: pos.x - this.containerArray["EmitterContainer"].worldTransform.tx, y: pos.y - this.containerArray["EmitterContainer"].worldTransform.ty };
            this.movementVectorPlayer.x = secondDirection.x;
            this.movementVectorPlayer.y = secondDirection.y;
            var dotProduct = firstDirection.x * secondDirection.x + firstDirection.y * secondDirection.y;
            var determinant = firstDirection.x * secondDirection.y - firstDirection.y * secondDirection.x;
        ...
        Main.prototype.CalculateInOtherDirection = function (e) {
            var pos = e.data.global;
            var firstDirection = { x: 1, y: 0 };
            var secondDirection = { x: pos.x - this.containerArray["EmitterContainer"].worldTransform.tx, y: pos.y - this.containerArray["EmitterContainer"].worldTransform.ty };
            this.movementVectorPlayer.x = secondDirection.x;
        ...
        Main.prototype.SetPlayerMovementVector = function (e) {
            if (this.pointerDown) {
                ...
                var ctr = 0;
                var _this_2 = this;
                _this_2.currentlyPlayingPlayers = 0;
                var _loop_1 = function (playerId) {
                    _this_2.currentlyPlayingPlayers++;
                    setTimeout(function () {
                        var squareRoot = Math.sqrt(_this_2.movementVectorPlayer.x * _this_2.movementVectorPlayer.x + _this_2.movementVectorPlayer.y * _this_2.movementVectorPlayer.y);
                        _this_2.movementVectorPlayer.x = _this_2.movementVectorPlayer.x / squareRoot;
                        _this_2.movementVectorPlayer.y = _this_2.movementVectorPlayer.y / squareRoot;
                        _this_2.playerArray[playerId].removeAndAddNewBody(_this_2.playerArray[playerId].x, _this_2.playerArray[playerId].y, 10);
                        _this_2.playerArray[playerId].setMovementVector(_this_2.movementVectorPlayer.x, _this_2.movementVectorPlayer.y);
                        _this_2.ballMoving = true;
                        _this_2.playerArray[playerId].collisionActive = true;
                        _this_2.playerArray[playerId].MovementActive = true;
                    }, 50 * ctr);
                    ctr++;
                };
                ...
                window.removeEventListener("touchmove", this.boundedFunctionArray[0]);
                window.removeEventListener("touchstart", this.boundedFunctionArray[1]);
                window.removeEventListener("touchend", this.boundedFunctionArray[2]);
            }
        };
        ...
        Main.prototype.StartGame = function () {
            ...
            window.addEventListener("touchstart", this.HideInitialAnimObj, true);
        };
        Main.prototype.HideInitialAnim = function () {
            ...
            window.removeEventListener("touchstart", this.HideInitialAnimObj, true);
        ...
        Main.prototype.BindDirectionVectors = function () {
            ...
            window.addEventListener("touchmove", this.boundedFunctionArray[0]);
            window.addEventListener("mousedown", this.boundedFunctionArray[1]);
            window.addEventListener("mouseup", this.boundedFunctionArray[2]);
            window.addEventListener("touchstart", this.boundedFunctionArray[1]);
            window.addEventListener("touchend", this.boundedFunctionArray[2]);
        };
                ...
                for (var player in this.playerArray) {
                    if (this.playerArray.hasOwnProperty(player)) {
                        ...
                        if (this.playerArray[player].y > 500 && !this.playerArray[player].bodyRemoved) {
                            ...
                            if (this.playersDroppedDown == 1) {
                                this.firstDrop = this.playerArray[player];
                            }
                            else {
                                this.MoveToFirstDrop(this.playerArray[player]);
                            }
                            if (this.playersDroppedDown == this.currentlyPlayingPlayers) {
                                this.currentlyPlayingPlayers = 0;
                                _this.ballMoving = false;
                                this.playersDroppedDown = 0;
                                if (this.blockCouter >= 7) {
                                    if (Object.keys(this.destructibleCubeArray[this.blockCouter - 7]).length > 0) {
                                        _this.MoveDownAndDestroyAll();
                                    }
                                    else {
                                        _this.continueNormalSequence();
                                    }
                                }
                                else {
                                    _this.continueNormalSequence();
        ...
        Main.prototype.continueNormalSequence = function () {
            var _this = this;
            setTimeout(function () {
        ...
        Main.prototype.TweenFakePlayerDown = function (index, fakePlayer) {
            ...
            this.tweenedDownPlayer.push(this.fakePlayerArray[index][fakePlayer]);
        ...
        Main.prototype.CreatePlayersFromFakeOnes = function () {
            for (var _i = 0, _a = this.tweenedDownPlayer; _i < _a.length; _i++) {
                var fakePlayer = _a[_i];
                var timeLineTween = new TimelineMax({
                    onComplete: this.CreateNewPlayer.bind(this, this.firstDrop.x, 485, fakePlayer),
                });
                timeLineTween.to(fakePlayer, { duration: 0.5, x: this.firstDrop.x, y: 485 });
                // this.CreateNewPlayer(fakePlayer.x, 485, fakePlayer);
            }
            this.tweenedDownPlayer = [];
        };
        Main.prototype.CreateNewPlayer = function (x, y, fakePlayer) {
            // let toDestroy = this.fakePlayerArray[index][fakePlayer];
            // delete this.fakePlayerArray[index][fakePlayer];
            var toDestroy = fakePlayer;
            // delete fakePlayer;
            toDestroy.destroy();
            this.playerNum++;
            var newSprite = new surya_1.CollisionShape(true, "circle", x, y, surya_1.circleRad, surya_1.circleRad, { isStatic: false, friction: 0, restitution: 1, inertia: Infinity, frictionAir: 0, frictionStatic: 0, collisionFilter: { category: 0x0002, mask: 0x0001 } });
            newSprite.justRemoveBody();
            newSprite.beginFill(0xffffff, 1).drawCircle(0, 0, surya_1.circleRad).endFill();
        ...
        Main.prototype.MoveAllPlayersToOriginalPos = function () {
            for (var player in this.playerArray) {
                if (this.playerArray.hasOwnProperty(player)) {
                    gsap.to(this.playerArray[player], { x: this.firstDrop.x, y: 485, duration: 0.5 });
                }
            }
            var _this = this;
            setTimeout(function () {
                _this.CreatePlayersFromFakeOnes();
                setTimeout(function () {
                    _this.BindDirectionVectors();
                    var curNumBalls = _this.playerNum + 1;
                    _this.numberOfBallsText.text = "" + curNumBalls;
                    _this.numberOfBallsText.x = _this.firstDrop.x - _this.numberOfBallsText.width / 2;
                    _this.numberOfBallsText.visible = true;
                    _this.drawBlockShapes(++_this.blockCouter);
                }, 505);
            }, 500);
        };
        Main.prototype.MoveToFirstDrop = function (toMove) {
            gsap.to(toMove, { x: this.firstDrop.x, y: 485, duration: 0.5 });
        };
        Main.prototype.MoveDownAndDestroyAll = function () {
            var ctrDropping = 0;
            var _loop_2 = function (ctr) {
                var _this = this_1;
                for (var fakePlayerIndex in this_1.fakePlayerArray[ctr]) {
                    this_1.fakePlayerArray[ctr][fakePlayerIndex].destroy();
                }
                var timeOutValue = 0;
                if (Object.keys(this_1.destructibleCubeArray[ctr]).length > 0) {
                    timeOutValue = ctrDropping * 500;
                    ctrDropping++;
                }
                setTimeout(function () {
